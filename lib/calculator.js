...
var CalcApp = function (_React$Component) {
  ...
  function CalcApp(props) {
    ...
    _this.clearCurrentOperand();
    _this.lastOperand = null;
    _this.operator = null;
    _this.isLastEqual = false;
    return _this;
  }
  ...
  _createClass(CalcApp, [{
    ...
    key: 'clearCurrentOperand',
    value: function clearCurrentOperand() {
      this.operand = 0;
      this.precision = -1;
    ...
    key: 'clickSign',
    value: function clickSign() {
      if (this.isLastEqual) this.resetState();
    ...
    value: function refreshDisplay() {
      ...
      if (this.negativeSign) display = '-' + display;
    ...
    value: function clickOperator(operator) {
      ...
      if (operator === '=') this.isLastEqual = true;else this.isLastEqual = false;
    }
  }, {
    key: 'getOperand',
    value: function getOperand(operand, precision) {
      if (this.precision !== -1) operand *= Math.pow(10, -precision);
      if (this.negativeSign) operand = -operand;
      return operand;
    }
  }, {
    key: 'evaluate',
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              CalcButton,
              { onClick: this.clickSign.bind(this) },
              '+/-'
            ),
            React.createElement(
              CalcButton,
